...
const BentoGrid = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & VariantProps<typeof bentoGridVariants>>(
  ({ variant, className, ...props }, ref) => <div ref={ref} className={cn(bentoGridVariants({ variant }), className)} {...props} />
)
...
const BentoCell = React.forwardRef<HTMLDivElement, HTMLMotionProps<"div">>(({ className, style, ...props }, ref) => {
  ...
  return <motion.div ref={ref} className={className} style={{ translate, scale, ...style }} {...props} />
})
BentoCell.displayName = "BentoCell"

const ContainerScale = React.forwardRef<HTMLDivElement, HTMLMotionProps<"div">>(({ className, style, ...props }, ref) => {
  const { scrollYProgress } = useContainerScrollContext()
